...
public class PaymentDetailsWatcher implements TextWatcher {
     ...
     */
    public PaymentDetailsWatcher(int paddingPx) {
     ...
     */
    public PaymentDetailsWatcher(@NonNull TextView textView) {
     ...
     */
    public PaymentDetailsWatcher(@NonNull TextView textView, float paddingEm) {
     ...
     */
    public PaymentDetailsWatcher(@NonNull Context context, float paddingSp) {
